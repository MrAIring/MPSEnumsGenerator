...
<model ref="r:c1645389-53a1-4316-a810-e63b5cddcf4f(baseLanguageOverridePackageNaming.textGen)">
  ...
  <node concept="1bsvg0" id="7KndbiP$iF5">
    <property role="TrG5h" value="BaseLanguageTextGenOverridePackage" />
    ...
    <node concept="1JqxBV" id="hXZAS9u" role="1Jy66y">
      ...
      <node concept="3clFbS" id="hXZAS9w" role="3clF47">
        <node concept="3cpWs6" id="hXZB0rA" role="3cqZAp">
          <node concept="Xl_RD" id="7KndbiP$jQF" role="3cqZAk">
            <property role="Xl_RC" value="superpackage" />
          </node>
        </node>
      </node>
